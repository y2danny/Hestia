    ...
    return (
      <div>
          ...
          <section className="text-gray-600 body-font mt-10">
            <div className="container bg-green-900 space-x-40 rounded-2xl ml-20 px-5 py-24 mx-auto flex items-center md:flex-row flex-col ">
                <div className="flex flex-col ml-10 pl-20  md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
                    <h2 className="text-3xl mb-4 text-white tracking-widest font-medium title-font mb-1">Have property to sell?</h2>
