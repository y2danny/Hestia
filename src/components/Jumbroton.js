...
const aa = "sdsd";
const Jumbroton = ({ realestate, escrow, aa }) => {
  function showDialog() {
  ...
  return (
    <div>
      <div className="text-center bg-gray-50 text-gray-800 py-24 px-6">
        <h3 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">
          A Home Away From Home
          <br />
          <span className="text-blue-600">Buy, Rent and Sell Properties</span>
        </h3>
      ...
      <section className="text-gray-600 body-font">
        ...
        <div
          ...
          className="
                ...
                drop-shadow-lg"
        >
          <Mint escrow={escrow} realestate={realestate} aa={aa} />
        </div>
      </section>
    </div>
  );
