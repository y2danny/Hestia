        ...
        <div className="container mx-auto flex md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <img
              ...
              alt="hero"
              src="https://uortjlczjmucmpaqqhqm.supabase.co/storage/v1/object/public/firejet-converted-images/images/2e2ca50333750c5aa3ab66719b6409308fd02d92.webp"
            />
          </div>
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">
              Fully furnished with householde items all ensuite. 24/hr
              Electricity, solar powered and smart home
            </p>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex justify-center mb-4 mt-4">
            <button className="bg-purple-800 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
